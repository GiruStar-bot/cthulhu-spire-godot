...
const CARDS := {
	...
	"wind_gods_bow": {
		...
		"text": "敵全体に18ダメージ。",
		"upgradedText": "敵全体に18ダメージ。",
		"flavor": "", "art": "res://art/pixel/cards/hastur_bow.jpg", "target": "all",
	...
	"spellbook": {
		...
		"flavor": "読む者の方が、読まれている。", "art": "", "target": "none",
	...
	"ultimate_arcane": {
		...
		"flavor": "四つの理が、ひとつの終わりを指す。", "art": "", "target": "all",
	...
	"wisdom": {
		...
		"flavor": "理解は、紙より先に心を裂く。", "art": "", "target": "none",
	...
	"restoration": {
		...
		"flavor": "異なる流れが、ひとつの命を満たす。", "art": "", "target": "none",
